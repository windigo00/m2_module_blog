...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()
			->newTable( $installer->getTable('blog') )
			->addColumn( 'blog_id',		Table::TYPE_SMALLINT,	NULL,	['identity' => true, 'nullable' => false, 'primary' => true], 'Blog ID')
        ...
        $table = $installer->getConnection()
			...
			->addColumn( 'blog_id',	 Table::TYPE_SMALLINT, null, ['nullable' => false, 'primary' => true], 'Blog ID' )
			...
			->addForeignKey(
				...
				$installer->getTable('blob'), 'blog_id',
